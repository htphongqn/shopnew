        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    txtHotline.Value = G_info.ToList()[0].ONLINE_FIELD2;
        ...
        private void SaveInfo(string strLink = "")
        {
            try
            {
                ...
                if (m_online_id == 0)
                {
                    ...
                    g_insert.ONLINE_FIELD2 = txtHotline.Value;
                    ...
                    //g_insert.ONLINE_LANGUAGE = lang;// Utils.CIntDef(rblLanguage.SelectedValue);
                ...
                else
                {
                    ...
                    if (g_update.ToList().Count > 0)
                    {
                        ...
                        //g_update.Single().ONLINE_LANGUAGE = lang;// Utils.CIntDef(rblLanguage.SelectedValue);
