            ...
            <tr id="trHotel" runat ="server" visible="false">
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <textarea id="txtTongquan" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtCSVC" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtBando" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtKhuyenmai" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtGia" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr id="trProject" runat ="server" visible ="false">
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <textarea id="txtGioithieuchung" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtVitri" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtmatbang" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtTienich" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtKientruc" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
