...
<body>
    ...
    <div id="outer">
        <div id="logo">
            <img src="../Images/Logo.png" alt="" style="border: none"/></div>
        <div id="content">
            <div id="login">
                ...
                <div id="information">
                    <table width="332" border="0" cellpadding="3" style="padding-top: 15px;">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <label>
                                    <asp:DropDownList ID="ddlNN" runat="server">
                                        <asp:ListItem Value="1" Text="Việt nam"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Anh"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Nga"></asp:ListItem>
                                        <asp:ListItem Value="4" Text="Trung quốc"></asp:ListItem>
                                    </asp:DropDownList>
                                </label>
                            </td>
                        </tr>
        ...
        <div id="footer">
            © Copyright by Dang Cap Viet JSC</div>
    </div>
    </form>
</body>
</html>
