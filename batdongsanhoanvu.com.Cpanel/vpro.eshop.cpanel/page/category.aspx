            ...
            <tr style="height: 20px;">
                ...
                <td height="25">
                    <asp:RadioButtonList ID="rblCatType" runat="server" RepeatColumns="5">
                        <asp:ListItem Text="Dự án" Value="1" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Khách sạn" Value="2"></asp:ListItem>
                        <asp:ListItem Text="Tin tức" Value="3"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <%--  <tr style="height: 20px;">
            ...
            <tr style="height: 20px;">
                ...
                <td height="25">
                    <asp:RadioButtonList ID="rblPos" runat="server" RepeatColumns="5">
                        ...
                        <asp:ListItem Text="Trên" Value="2"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr style="height: 20px;">
