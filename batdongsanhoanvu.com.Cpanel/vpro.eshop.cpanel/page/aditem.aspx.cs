    ...
    public partial class aditem : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ucHeader.HeaderLevel2_Url = "../page/aditem.aspx";
        ...
        private void SaveInfo(string strLink = "")
        {
            try
            {
                ...
                if (m_ad_id == 0)
                {
                    ...
                    g_insert.AD_ITEM_LANGUAGE = lang;// Utils.CIntDef(rblLanguage.SelectedValue);
                ...
                else
                {
                    ...
                    if (g_update.ToList().Count > 0)
                    {
                        ...
                        g_update.Single().AD_ITEM_LANGUAGE = lang;// Utils.CIntDef(rblLanguage.SelectedValue);
