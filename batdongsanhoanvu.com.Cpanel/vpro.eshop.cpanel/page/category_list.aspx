...
<%--        <div class="icon_function_Child">
        ...
        <div class="icon_function_Child">
            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="lbtSave_Click"><img src="../Images/ICON_SAVE.jpg" width="30" height="30" style="border: 0px" /><div>
            ...
            <tr>
                <td colspan="3">
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        Width="100%" DataKeyField="CAT_ID" CssClass="tdGridTable" 
                        ...
                        AllowSorting="true" OnItemCommand="GridItemList_ItemCommand" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tên chuyên mục" HeaderStyle-Width="92%" ItemStyle-Wrap="False"
                            ...
                            <asp:TemplateColumn HeaderText="Ngôn ngữ" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="CAT_LANGUAGE">
                                <ItemTemplate>
                                    <%# getLanguage(DataBinder.Eval(Container.DataItem, "CAT_LANGUAGE"))%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                                </HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Left"></ItemStyle>
                            ...
                            <asp:TemplateColumn HeaderText="Thứ tự trang chủ" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
