...
namespace Controller
{
    public class Function
    {
        ...
        public string GetImageAd1(object Ad_Id, object Ad_Image1, object Ad_Target, object Ad_Url, string Class)
        {
            ...
            {
                if (Utils.CIntDef(Ad_Id) > 0 && !string.IsNullOrEmpty(Utils.CStrDef(Ad_Image1)))
                    return "<a class='"+Class+"' href='" + Utils.CStrDef(Ad_Url) + "' target='" + Utils.CStrDef(Ad_Target) + "'><img src='" + PathFiles.GetPathAdItems(Utils.CIntDef(Ad_Id)) + Utils.CStrDef(Ad_Image1) + "' alt='' width='100%' /></a>";
                return "";
            }
            catch (Exception ex)
            {
        ...
        public string Getbanner(object Banner_type, object banner_field, object Banner_ID, object Banner_Image)
        {
            ...
            return banner == "1" ? "<div id='logo' class='fl'><a href='/'>" + GetImage(Banner_type, Banner_ID, Banner_Image) + "</a></div>" : "<a href='/' id='logo' class='fl'>" + GetImagebanner(Banner_type, Banner_ID, Banner_Image) + "</a>";
        }
