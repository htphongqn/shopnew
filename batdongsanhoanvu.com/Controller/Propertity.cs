...
namespace Controller
{
    public class Propertity
    {
        ...
        #endregion
        //Menu
        public List<ESHOP_CATEGORy> Loadmenu(int position, int limit, int rank, int lang)
        {
            try
            {
                var list = db.ESHOP_CATEGORies.Where(n => n.CAT_STATUS == 1 && n.CAT_POSITION == position && n.CAT_RANK == rank && n.CAT_LANGUAGE == lang).OrderByDescending(n=>n.CAT_ORDER).Take(limit).ToList();
                return list;
            }
            catch (Exception)
            {
        ...
        public List<ESHOP_CATEGORy> MenuHotel(int position, int limit, int rank, int lang)
        {
            try
            {
        ...
        public List<ESHOP_CATEGORy> Load_danhmuc_position(int rank, int postion, int lang)
        {
            var list = db.ESHOP_CATEGORies.Where( n=> n.CAT_RANK == rank 
                && n.CAT_STATUS == 1
                && n.CAT_POSITION==postion
                && n.CAT_LANGUAGE == lang).OrderByDescending(n => n.CAT_ORDER).ToList();
            return list;
        }
        ...
        public List<ESHOP_CATEGORy> LoadmenuNews(int position, int limit, int rank)
        {
            try
            {
                var list = db.ESHOP_CATEGORies.Where(n => n.CAT_STATUS == 1 && n.CAT_POSITION == position && n.CAT_RANK == rank && n.CAT_TYPE == 0).OrderByDescending(n => n.CAT_ORDER).Take(limit).ToList();
                return list;
            }
            catch (Exception)
            {
        ...
        public List<ESHOP_BANNER> Load_logo_and_sologan(int limit, int lang)
        {
            try
            {
                 var _logoSlogan = (from a in db.ESHOP_BANNERs
                                    where (a.BANNER_LANGUAGE == lang || a.BANNER_LANGUAGE == 10)
        ...
        //Logo or sologan
        public List<ESHOP_BANNER> Load_logo_or_sologan(string field, int limit, int lang)
        {
            try
            {
                var list = db.ESHOP_BANNERs.Where(n => n.BANNER_FIELD1 == field && n.BANNER_LANGUAGE == lang).Take(limit).ToList();
                return list;
            }
            catch (Exception)
            {
        ...
        public List<ESHOP_AD_ITEM> Load_slider(object catid, int position, int limit, int lang)
        {
            try
            {
                var list = (from a in db.ESHOP_AD_ITEM_CATs
                            ...
                            && (b.AD_ITEM_LANGUAGE == lang || b.AD_ITEM_LANGUAGE == 10)
                            && (a.CAT_ID == Utils.CIntDef(catid, 0) || catid == null)
        ...
        public List<ESHOP_AD_ITEM> Load_slider1(int position, int limit, int lang)
        {
            try
            {
                var list = db.ESHOP_AD_ITEMs.Where(n => n.AD_ITEM_POSITION == position 
                    && (n.AD_ITEM_LANGUAGE == lang || n.AD_ITEM_LANGUAGE == 10)).Take(limit).ToList();
                return list;
            }
            catch (Exception)
            {
        ...
        public List<ESHOP_ONLINE> Load_support(int lang)
        {
            try
            {
                var list = db.ESHOP_ONLINEs.Where(n => n.ONLINE_TYPE <= 2 &&n.ONLINE_TYPE>-1 && n.ONLINE_LANGUAGE == lang).OrderByDescending(n => n.ONLINE_TYPE).ToList();
                return list;
            }
            catch (Exception)
            {
        ...
        //Holine
        //public List<ESHOP_ONLINE> Load_hotline(int lang)
        //{
        //    try
        //    {
