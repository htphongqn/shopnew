<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="project_ch.ascx.cs" Inherits="CatTrang.UIs.project_ch" %>
...
<div class="padding10">      
      ...
      <div class="fr" id="main_col">
        ...
        <div class="box" id="project_dt">
          ...
          <a href="/ch/order.html" class="order_btn">秩序</a></h1>
              ...
              <div class="tab_ct text_content">
                ...
                <div class="project_col fullsize fl">
                  ...
                  <div class="project_info">
                    <p class="hotline">热线:<br>
                      <b><asp:Label ID="lbHotline" runat="server" Text="" /> </b></p>
                      <asp:HyperLink ID="hplGooglemap" runat="server" Visible ="false" CssClass="show-map" 
                      Text="查看谷歌地图项目位置"></asp:HyperLink> 
                    </div>
                </div>
