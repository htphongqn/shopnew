...
namespace CatTrang.UIs
{
    public partial class header_en : System.Web.UI.UserControl
    {
        ...
        protected void loadMenuHotel()
        {
            try
            {
                var listhotel = per.MenuHotel(1, 12, 1, 2);
        ...
        {
            return fun.GetbannerEn(Banner_type, banner_field, Banner_ID, Banner_Image);
        }
        ...
        {
            Response.Redirect("/search.html?page=0&keyword=" + q.Value);
        }
    }
}