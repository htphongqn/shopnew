...
{
    public partial class new_ch : System.Web.UI.UserControl
    {
        ...
        //        if (list != null && list.Count > 0)
        //        {
        //            liHtml.Text = pro_detail.Show_File_HTML(list[0].NEWS_ID, "-ch.htm");
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        private void Show_File_HTML()
        {
            try
            {
                ...
                liHtml.Text = ndetail.Showfilehtm(_sCat_Seo_Url, _sNews_Seo_Url, "-ch.htm");
            }
            catch (Exception ex)
            {
                clsVproErrorHandler.HandlerError(ex);
