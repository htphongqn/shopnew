<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="project_ru.ascx.cs" Inherits="CatTrang.UIs.project_ru" %>
<%@ Register src="projectsLeft_ru.ascx" tagname="projectsLeft_vi" tagprefix="uc2" %>
...
<div class="padding10">      
      ...
      <div class="fr" id="main_col">
        ...
        <div class="box" id="project_dt">
          ...
          <a href="/ru/order.html" class="order_btn">порядок</a></h1>
              ...
              <div class="tab_ct text_content">
                ...
                <div class="project_col fullsize fl">
                  ...
                  <div class="project_info">
                    <p class="hotline">горячая линия:<br>
                      <b><asp:Label ID="lbHotline" runat="server" Text="" /> </b></p>
                      <asp:HyperLink ID="hplGooglemap" runat="server" Visible ="false" CssClass="show-map" Text="Посмотреть на Google Maps проекта"></asp:HyperLink> 
                    </div>
                </div>
