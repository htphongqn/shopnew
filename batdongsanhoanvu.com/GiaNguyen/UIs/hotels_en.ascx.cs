...
{
    public partial class hotels_en : System.Web.UI.UserControl
    {
        #region Declare
        ...
        protected void rptListHotel_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "tongquan")
            {
                ...
                {
                    if (lnkTongquan.Text == "Show more")
                    {
                        HtmlTongquan.Text = Show_File_HTML(e.CommandArgument, "tongquankhachsan-en.htm");
                        lnkTongquan.Text = "Show less";
                    }
                    else
                    {
                        HtmlTongquan.Text = GetShortName(Show_File_HTML(e.CommandArgument, "tongquankhachsan-en.htm"), 400);
                        lnkTongquan.Text = "Show more";
                    }
                }
            }
            else if (e.CommandName == "cosovatchat")
            {
                ...
                {
                    if (lnkCosovatchat.Text == "Show more")
                    {
                        HtmlCosovatchat.Text = Show_File_HTML(e.CommandArgument, "cosovatchat-en.htm");
                        lnkCosovatchat.Text = "Show less";
                    }
                    else
                    {
                        HtmlCosovatchat.Text = GetShortName(Show_File_HTML(e.CommandArgument, "cosovatchat-en.htm"), 400);
                        lnkCosovatchat.Text = "Show more";
                    }
                }
            }
        }
