<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="hotels_vi.ascx.cs" Inherits="CatTrang.UIs.hotels_vi" %>
<%@ Register src="path_vi.ascx" tagname="path_vi" tagprefix="uc1" %>
          ...
          <div id="list_hotels">
            ...
            <asp:Repeater ID="rptListHotel" runat="server" 
              ...
              <li class="item_hotel">
                ...
                <a title="Xem bản đồ" target="_blank" href="<%# Eval("GOOGLEMAPSLINK") %>">(Xem bản đồ)</a> <br>
                ...
                <div class="horizontalTab cf">
                  ...
                  <div class="resp-tabs-container">
                    ...
                    <Triggers>
                        ...
                        <ContentTemplate>                      
                        <asp:Literal ID="HtmlTongquan" runat="server" Text='<%# GetShortName(Show_File_HTML(Eval("NEWS_ID"),"tongquankhachsan-vi.htm"), 400) %>'></asp:Literal>
                        <asp:LinkButton ID="lnkTongquan" runat="server" CommandName="tongquan" CommandArgument='<%#Eval("NEWS_ID")%>' Text="Xem thêm" Font-Bold="True"></asp:LinkButton>
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    <div class="tab_ct text_content">                      
                    ...
                    <Triggers>
                        ...
                        <ContentTemplate>                      
                        <asp:Literal ID="HtmlCosovatchat" runat="server" Text='<%# GetShortName(Show_File_HTML(Eval("NEWS_ID"),"cosovatchat-vi.htm"), 400) %>'></asp:Literal>
                        <asp:LinkButton ID="lnkCosovatchat" runat="server" CommandName="cosovatchat" CommandArgument='<%#Eval("NEWS_ID")%>' Text="Xem thêm" Font-Bold="True"></asp:LinkButton>
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    <div class="tab_ct"> 
                    <asp:Literal ID="HtmlBando" runat="server" Text='<%# Show_File_HTML(Eval("NEWS_ID"),"bando-vi.htm") %>'></asp:Literal>
                    </div>
                    <div class="tab_ct">
                    <ul class="photo">
                    <asp:Repeater ID="rptImages" runat="server" DataSource='<%# GetImages(Eval("NEWS_ID")) %>'>
                      ...
                      <a href="/gallery.html" data-href="/hyatt/ajax/passthrough.jsp?language=en&amp;spiritcode=saiph&amp;brand=park" id="openMultimedia" class="openMultimedia">View Photos</a> 
                      </div>
                    </div>
                  </div>
                </div>
