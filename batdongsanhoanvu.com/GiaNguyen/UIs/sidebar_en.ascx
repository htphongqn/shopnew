<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="sidebar_en.ascx.cs" Inherits="CatTrang.UIs.sidebar_en" %>
          ...
          <div id="search_ht_content">
            ...
            <div class="form_row_search fl">
              ...
              <div class="col_form_search fr">
                <label class="left_row_search">To date</label>
            ...
            <div class="form_row_search fl">
              <label class="left_row_search fl">Room type</label>
              <div class="styled-select fr">
                <asp:DropDownList ID="ddlHotelClass" runat="server" Width="100px">
                    <asp:ListItem Value="1" Text="Room vip"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="Room often"></asp:ListItem> 
            ...
            <div class="form_row_search aut fl">
              <label class="left_row_search fl">Adult</label>
              <div class="styled-select fr">
            ...
            <div class="form_row_search chd fl">
              <label class="left_row_search fl">Child</label>
              <div class="styled-select fr">
            ...
            <div class="form_row_search fl">
              <label class="left_row_search">Full name:</label>
            ...
            <div class="form_row_search fl">
              <label class="left_row_search">Phone:</label>
