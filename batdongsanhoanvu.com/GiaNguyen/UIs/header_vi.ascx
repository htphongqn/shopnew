<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="header_vi.ascx.cs" Inherits="CatTrang.UIs.header_vi" %>
...
<header>
        ...
        <div id="find_hotel_area" class="fl">
          <div class="link_find_hotel"><span class="ico ico_address"></span> 
            <a href="javascript:void(0)">Tìm khách sạn<span class="ico ico_square_arrow"></span></a> 
          </div>
        ...
        <div id="drop_linkhotel">
          <asp:DropDownList ID="ddlFindHotel" runat="server" class="sl_find_hotel" name="link_find_hotel" DataValueField="CAT_ID" DataTextField="cat_name" AppendDataBoundItems="true">
            <asp:ListItem Value="0" Text="Tìm khách sạn"></asp:ListItem>
          </asp:DropDownList>
        </div>
          ...
          <div class="row_head row_h2">
            ...
            <div class="fr" id="search_box_head">
              <div id="search_head">
                ...
                <input type="text" onblur="javscript:if (this.value == '') this.value = 'Tìm kiếm...';" onfocus="javascript:if (this.value == 'Tìm kiếm...') this.value = '';" value="Tìm kiếm..." name="keyword" id="q" runat="server" class="inputSearch" />      
