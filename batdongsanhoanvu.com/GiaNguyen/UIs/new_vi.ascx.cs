...
{
    public partial class new_vi : System.Web.UI.UserControl
    {
        ...
        List_news listnew = new List_news();
        ...
        //        if (list != null && list.Count > 0)
        //        {
        //            liHtml.Text = pro_detail.Show_File_HTML(list[0].NEWS_ID, "-vi.htm");
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        private void Get_ViewMore()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(_sCat_Seo_Url))
                {
                    string Catseourl = listnew.GetCateSeoParent(_sCat_Seo_Url);
                    hplViewmore.HRef = ndetail.Get_ViewMore(Catseourl);
                }
                else
                {
