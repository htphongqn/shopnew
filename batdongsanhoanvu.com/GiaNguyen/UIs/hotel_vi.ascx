<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="hotel_vi.ascx.cs" Inherits="CatTrang.UIs.hotel_vi" %>
...
<div class="padding10">
      ...
      <div class="fl" id="main_col">
        ...
        <div class="box" id="detail_news">
          ...
          <div class="price_dt fullsize fr"> Giá trung bình / đêm<span><b><asp:Literal ID="lbPrice" runat="server"></asp:Literal></b> <sup><u>đ</u></sup></span> </div>
        ...
        <div class="box" id="carousel_hotels">
          <div class="box_Tab">Khách sạn tương tự</div>
          <div id="slide_hotels">
            <ul>              
