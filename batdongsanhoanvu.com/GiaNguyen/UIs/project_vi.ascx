<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="project_vi.ascx.cs" Inherits="CatTrang.UIs.project_vi" %>
<%@ Register src="projectsLeft_vi.ascx" tagname="projectsLeft_vi" tagprefix="uc2" %>
...
<div class="padding10">      
      ...
      <div class="fr" id="main_col">
        ...
        <div class="box" id="project_dt">
          ...
          <a href="/order.html" class="order_btn">ORDER</a></h1>
                ...
                <div class="project_col fullsize fl">
                  ...
                  <div class="project_info">
                    <p class="hotline">Hotline:<br>
                      ...
                      <asp:HyperLink ID="hplGooglemap" runat="server" Visible ="false" CssClass="show-map" Text="Xem vị trí dự án trên Google Maps"></asp:HyperLink> 
                    </div>
                </div>
        ...
        height: 480px; overflow: hidden;">
              ...
              <div class="tab_ct text_content">
                ...
                <%--<a href="<%# GetLink(Eval("NEWS_URL"),Eval("NEWS_SEO_URL"),Eval("CAT_SEO_URL")) %>"
                                class="img_product trans" title="<%#Eval("NEWS_TITLE") %>" onmouseout="BBTOnline_HideTooltip();" onmouseover="BBTOnline_ShowTooltip('../ajax/vi-vnToolTip.aspx?purl=<%# Eval("NEWS_SEO_URL") %>'); return false;">
                    <img src="<%# GetImageT(Eval("NEWS_ID"),Eval("NEWS_IMAGE3")) %>" alt="<%#Eval("NEWS_TITLE") %>" />
                </a>--%>
                <%--<a href="javascript:void(0)" title="" onmouseout="BBTOnline_HideTooltip();" onmouseover="BBTOnline_ShowTooltip('../ajax/vi-vnToolTip.aspx?purl=1'); return false;">
                    <img src="../Images/maps_HoanVu.jpg" />
                </a>--%>
                <img border="0" src="../Images/maps_HoanVu.jpg" usemap="#quanhuyen" width="873" height="614" style="" />
                <a href="javascript:void(0)" title="" onmouseout="BBTOnline_HideTooltip();" onmouseover="BBTOnline_ShowTooltip('../ajax/vi-vnToolTip.aspx?purl=1'); return false;">
                <map name="quanhuyen">
                  <area href="/du-an/the-point.html" shape="circle" coords="88,160,12" />
                </map>
                </a>
                <!--end Vi tri-->
              </div>
