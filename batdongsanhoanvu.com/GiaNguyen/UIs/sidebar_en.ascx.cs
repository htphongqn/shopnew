...
{
    public partial class sidebar_en : System.Web.UI.UserControl
    {
        #region Decclare
        ...
        public void Loadlist()
        {
            try
            {
                var list = list_pro.Load_listprobyPeriod(2, Cost.EN);
                if (list.Count > 0)
                {
        ...
        //    try
        //    {
        //        var list = per.Load_slider1(1, 30, 2).ToList();
        //        if (list.Count > 0)
        //        {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if(txtname_hotel.Value.Length  == 0)
            {
                ...
                strScript += "alert('Please enter the name of the hotel');";
                strScript += "</script>";
            ...
            {
                string strScript = "<script>";
                strScript += "alert(' Please select from date and to date');";
                strScript += "</script>";
                Page.RegisterClientScriptBlock("strScript", strScript);
                return;
            }
            ...
            {
                string strScript = "<script>";
                strScript += "alert(' Please enter the fullname');";
                strScript += "</script>";
                Page.RegisterClientScriptBlock("strScript", strScript);
                return;
            }
            ...
            {
                string strScript = "<script>";
                strScript += "alert(' Please enter the phone number');";
                strScript += "</script>";
                Page.RegisterClientScriptBlock("strScript", strScript);
                return;
            }
                ...
                strEmailBody += "BOOKING INFORMATION <br />";
                strEmailBody += " - From date: " + txtflights_checkin.Value + "<br />";
                strEmailBody += " - To date: " + txtflights_checkout.Value + "<br />";
                strEmailBody += " - Room: " + ddlHotelClass.SelectedItem.Text + "<br />";
                strEmailBody += " - Adult: " + ddlCusM.SelectedItem.Text + "<br />";
                strEmailBody += " - Child: " + ddlCusS.SelectedItem.Text + "<br />";

                strEmailBody += "CONTACT INFORMATION<br />";
                strEmailBody += " - Fullname: " + txtfullname.Value + "<br />";
                strEmailBody += " - Phone: " + txtphonenumber.Value + "<br />";
                ...
                sm1.SendMailAll(txtemail.Value, "", "Notice : You have successfully booked", strEmailBody, "Hoanvu");
                ...
                string str = "<script>";
                str += "alert(' Booking success!');";
                str += "window.location='/home.html';";
                str += "</script>";
