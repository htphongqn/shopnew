<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="hotel_en.ascx.cs" Inherits="CatTrang.UIs.hotel_en" %>
      ...
      <div class="fl" id="main_col">
        ...
        <div class="box" id="detail_news">
          ...
          <div class="address_detail fullsize fl">
            ...
            <p>Tel: <asp:Label ID="lbHotline" runat="server" Text="" /></p>
            <p>Email: <asp:Label ID="lbEmail" runat="server" Text="" /></p>
          </div>
          <div class="price_dt fullsize fr"> Average price / night<span><b><asp:Literal ID="lbPrice" runat="server"></asp:Literal></b> <sup><u>$</u></sup></span> </div>
        ...
        <div class="box" id="carousel_hotels">
          <div class="box_Tab">Similar Hotels</div>
          <div id="slide_hotels">
            <ul>              
