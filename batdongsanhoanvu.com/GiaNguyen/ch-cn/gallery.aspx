<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteCh.Master" AutoEventWireup="true" CodeBehind="gallery.aspx.cs" Inherits="CatTrang.ch_cn.gallery" %>
...
<div class="padding10">
      ...
      <div class="fl" id="main_col">
        <div class="path"><a href="/设为首页.html">家</a> &raquo; <a href="/ch/gallery.html">图像</a></div>
        <!--Gallery Images-->
