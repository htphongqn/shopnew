    ...
    public partial class Page_Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UserControl uProjects = Page.LoadControl("../UIs/projects_ch.ascx") as UserControl;
                UserControl uProject = Page.LoadControl("../UIs/project_ch.ascx") as UserControl;
                UserControl uHotels = Page.LoadControl("../UIs/hotels_ch.ascx") as UserControl;
                UserControl uHotel = Page.LoadControl("../UIs/hotel_ch.ascx") as UserControl;
                UserControl uNews = Page.LoadControl("../UIs/news_ch.ascx") as UserControl;
                UserControl uNew = Page.LoadControl("../UIs/new_ch.ascx") as UserControl;
                UserControl uSearch = Page.LoadControl("../UIs/search_ch.ascx") as UserControl;
