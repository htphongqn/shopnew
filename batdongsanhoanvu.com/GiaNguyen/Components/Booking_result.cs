...
namespace Controller
{
    public class Booking_result
    {
        ...
        #endregion
        public void Add_booking(string namehotel, DateTime? day1, DateTime? day2, int Classtype, int peop1, int peop2, string fullname, string phone, string email)
        {
            ESHOP_CONTACT_BOOKING _contact = new ESHOP_CONTACT_BOOKING();
            _contact.CONT_HOTEL_TITLE = namehotel;
