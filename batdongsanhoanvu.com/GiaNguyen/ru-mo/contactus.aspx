<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteRu.Master" AutoEventWireup="true" CodeBehind="contactus.aspx.cs" Inherits="CatTrang.ru_mo.contactus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="padding10">
      <div class="path"><a href="/домой.html">домашняя страница</a> &raquo; <a href="/ru/контакт.html">связанный</a></div>
      <!--Main Column-->
      <div class="fr" id="main_col" style="width:100%">
        <!--Contact-->
        <link href="../Styles/contact.css" rel="stylesheet" type="text/css" />
        <div class="box">
          <div class="box_Tab">связанный</div>
          <div class="box_ct">
            ...
            <div class="fullsize form_web fr" id="contactus">
              <div class="row_account">
                ...
                <input type="text" class="inputbox" id="Txtname" runat="server">
                        <br>
                        <asp:RequiredFieldValidator ID="rfvHoVaTen" runat="server" ErrorMessage="Неизвестное имя"
              ...
              <div class="row_account">
                ...
                <input type="text" class="inputbox" id="Txtphone" runat="server">
                        <br>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Неизвестный номер телефона"
              ...
              <div class="row_account">
                ...
                <input type="text" class="inputbox" id="txtEmail" runat="server">
                        <br>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Неизвестный по электронной почте"
                            ControlToValidate="txtEmail" Display="Dynamic" ForeColor="Red" ValidationGroup="G40">*</asp:RequiredFieldValidator>
              </div>
              <div class="row_account">
                <label class="item_title"> Запрос:<span class="required">*</span></label>
                <textarea rows="10" cols="45" id="txtContent" name="ctl00$ContentPlaceHolder1$txtContent" runat="server" class="inputbox"></textarea>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Неизвестный содержание, связанное с"
