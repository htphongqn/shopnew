    ...
    public partial class Page_Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UserControl uProjects = Page.LoadControl("../UIs/projects_en.ascx") as UserControl;
                UserControl uProject = Page.LoadControl("../UIs/project_en.ascx") as UserControl;
                UserControl uHotels = Page.LoadControl("../UIs/hotels_en.ascx") as UserControl;
                UserControl uHotel = Page.LoadControl("../UIs/hotel_en.ascx") as UserControl;
                UserControl uNews = Page.LoadControl("../UIs/news_en.ascx") as UserControl;
                UserControl uNew = Page.LoadControl("../UIs/new_en.ascx") as UserControl;
                UserControl uSearch = Page.LoadControl("../UIs/search_en.ascx") as UserControl;
